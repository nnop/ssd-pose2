#ifndef CAFFE_DETECTION_EVALUATE_POSE_LAYER_HPP_
#define CAFFE_DETECTION_EVALUATE_POSE_LAYER_HPP_
...
class DetectionEvaluatePoseLayer : public Layer<Dtype> {
 public:
  explicit DetectionEvaluatePoseLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "DetectionEvaluatePose"; }
