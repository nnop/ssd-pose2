...
test_data = "data/3Dpascal/pascal3D/lmdb/pascal3D_test_lmdb"
...
if share_pose:
    mod_name = "SSD_share_pose_{}_{}_bins_{}".format(resize, num_poses, idx)
    job_name = "SSD_share_pose_{}_{}_bins_{}_test".format(resize, num_poses, idx)
else:
    mod_name = "SSD_seperate_pose_{}_{}_bins_{}".format(resize, num_poses, idx)
    job_name = "SSD_seperate_pose_{}_{}_bins_{}_test".format(resize, num_poses, idx)
# The name of the model. Modify it if you want.
model_name = "VGG_Pascal3D_{}".format(mod_name)
